...
function preload() {
   customFont = loadFont('ecritureautre.ttf');
   startImage = loadImage('start.png'); // Charger l'image pour "Commencer"
  // Charge les images
  girlImages.push(loadImage('afille.png')); // A. Ébouriffée
  girlImages.push(loadImage('bfille.png')); // B. Soignée
  girlImages.push(loadImage('cfille.png')); // C. Excentrique
  girlImages.push(loadImage('dfille.png')); // D. Mystérieuse
  girlImages.push(loadImage('efille.png')); // E. Têtue

  girlImages.push(loadImage('a2fille.png')); // A. attire les regards
  girlImages.push(loadImage('b2fille.png')); // B. se mêle aux autres
  girlImages.push(loadImage('c2fille.png')); // C. décalée
  girlImages.push(loadImage('d2fille.png')); // D. chic
  girlImages.push(loadImage('e2fille.png')); // E. nue
  
  girlImages.push(loadImage('a3fille.png')); // A. nage
  girlImages.push(loadImage('b3fille.png')); // B. montagne
  girlImages.push(loadImage('c3fille.png')); // C. trésor
  girlImages.push(loadImage('d3fille.png')); // D. danse
  girlImages.push(loadImage('e3fille.png')); // E. canapé
}
